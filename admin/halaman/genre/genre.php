...
<table align="center" class="table table-bordered table-striped table-hover" border="1">
    ...
    ?>
        ...
        <tr>
            ...
            <td align="center"> <?php echo $tampildata['nama_genre'] ?></td>
            
            <td align="center">
                <a href="halaman/genre/genreubah.php?idgenre=<?php echo $tampildata['id_genre']; ?>">
                    Edit
                </a>
                |
                <a href="halaman/genre/genrehapus.php?idgenre=<?php echo $tampildata['id_genre']; ?>" onclick="return confirm('Apa Anda yakin akan menghapus genre?')">
                    Delete
                </a>
            </td>
        </tr>
