...
<table align="center" class="table table-bordered table-striped table-hover">
    ...
    ?>
        ...
        <!--awal menampilkan data dari tabel film ke halaman web-->
        <tr>
            ...
            <td align="center">
                ...
                |
                <a href="halaman/film/filmhapus.php?id_film=<?php echo $tampildata['id_film'];?>" onclick="return confirm('Apa Anda yakin akan menghapus Data film?')">
                    Delete
                </a>
            </td>
        </tr>
        <!--akhir menampilkan data dari tabel film ke halaman web-->
